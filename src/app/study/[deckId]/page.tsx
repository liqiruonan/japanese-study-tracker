...
export default async function StudyPage({ params }: { params: Promise<{ deckId: string }> }) {
  ...
  if (finalCardIdsToFetch.length < MAX_CARDS_PER_SESSION) {
      ...
      <div className="flex-1 flex flex-col justify-center">
        {sessionCards.length > 0 ? (
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">No more cards due for review in this deck today.</p>
            <Link href="/decks">
